...
def TrainedCodes():
    #######################################################Zero##########################################3
    directory='./Data Set/Training Set/Code/0'
    Zero=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
    ...
    #######################################################One##########################################3
    directory='./Data Set/Training Set/Code/1'
    One=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
...
#######################################################Two##########################################3
    directory='./Data Set/Training Set/Code/2'
    Two=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
...
#######################################################Three##########################################3
    directory='./Data Set/Training Set/Code/3'
    Three=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
...
#######################################################Four##########################################3
    directory='./Data Set/Training Set/Code/4'
    Four=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
    ...
    #######################################################Five##########################################3
    directory='./Data Set/Training Set/Code/5'
    Five=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
...
#######################################################Six##########################################3
    directory='./Data Set/Training Set/Code/6'
    Six=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
    ...
    #######################################################Seven##########################################3
    directory='./Data Set/Training Set/Code/7'
    Seven=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
    ...
    #######################################################Eight##########################################3
    directory='./Data Set/Training Set/Code/8'
    Eight=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
        if os.path.isfile(f):
            ...
            Eight.append(fd_1)
    #######################################################Nine##########################################3
    directory='./Data Set/Training Set/Code/9'
    Nine=[]
    #Iterate over files in this Diretory
    for filename in os.listdir(directory):
        f=os.path.join(directory,filename)
